...
4. The deploy job logs into Azure with the service principal credentials, downloads the artifact, resolves up to three App Service targets, checks SCM/Kudu connectivity, and performs ZIP deploy with `az webapp deploy`.
